...
//    - To test: cargo run --bin prepare-prover-input -- --config inputs/mdl1/config.json --mdl generated_files/mdl1/mdl.cbor --prover_inputs generated_files/mdl1/prover_inputs.json --prover_aux generated_files/mdl1/prover_aux.json
